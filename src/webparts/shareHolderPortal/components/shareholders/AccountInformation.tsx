...
export class AccountInformation extends React.Component<any, any> {
  ...
  public constructor(props: any, state: any) {
    ...
    this.state = {
      ...
      shareholderEmail:this.props.shareholderEmail,
      accountDetails: [],
      stockandOptions: [],
        ...
        .then((d) => {
          if (d.length > 0) {
            ...
            this.setState({
              ...
              documentMailingZip1:
                dMailingZip[1] !== "undefined" ? dMailingZip[1] : "",
              ...
              allPaperlessElection:
                d[0].allPaperlessElection !== "No" ? true : false,
              ...
              // primaryHouseholdMailingAccount: JSON.parse(d[0].primaryHouseholdMailingAccount)
            });
          } else {
  ...
  public getShareholdingName = () => {
    ...
    newWeb.lists
      ...
      .filter(
        "shareholderID eq '" +
          this.state.properties.shareholderID +
          "' and shareholderEmail eq '" +
          this.state.properties.shareholderEmail +
          "'"
      )
      ...
      .then((d) => {
        if (d.length > 0) {
          if (this.state.shareholdingName !== null) {
            if (d[0].aceessType !== "Full Access") {
              this.setState({
                aceessType: d[0].aceessType,
                aceessType_ReadDeligae:true
              });
            } else {
              this.setState({
                aceessType: d[0].aceessType,
      ...
      .items.add({
        ...
        documentMailingLabelAddressee3:
          this.state.documentMailingLabelAddressee3 !== ""
            ? this.state.documentMailingLabelAddressee3
            : null,
        documentMailingAddressLine1: this.state.documentMailingAddressLine1,
        documentMailingAddressLine2:
          this.state.documentMailingAddressLine2 !== ""
            ? this.state.documentMailingAddressLine2
            : null,
        documentMailingCity: this.state.documentMailingCity,
        documentMailingState: this.state.documentMailingState,
        documentMailingZip:
            ...
            <div className={`card-body`}>
              ...
              <div className="row-fluid">
                <div className="col-md-12">
                  <FormControl fullWidth style={{ margin: "10px" }}  disabled={true}>
                    <DisbaleTextField
                    ...
                    <CustomTextField
                      ...
                      helperText={
                        this.state.shareholdingEmailAddress_Error === true
                          ...
                          : this.state.shareholdingEmailAddress_Validate ===
                            true
                ...
                <div className="col-md-12">
                  ...
                  >
                    <FormLabel
                      style={{
                        color:
                          this.state.pperlessOwnersReportsElection_Error !==
                          true
                            ? "#275458"
                            : "#dc3545",
                      }}
  ...
  public deligateReadAccessMessage = () => {
    let _html = (
      <React.Fragment>
        <Snackbar
          anchorOrigin={{
          ...
          <SnackbarContent
            ...
            message={
              <div id="message-id">
                ...
                />
                You are not authorized to make changes to this page as your
                access is limited to be "Read Only" by the shareholder.
                {/* <CancelIcon
                  style={{
                    marginLeft: "50px!important",
                    cursor: "pointer",
    ...
    return (
      <div className={styles.shareholders}>
        <div>
          ...
          <div className="row">
            <React.Fragment>
              {this.state.aceessType_ReadDeligae !== false ? (
                <React.Fragment>
                  {" "}
                  {this.deligateReadAccessMessage()}{" "}
                </React.Fragment>
              ) : (
                null
              )}
                      ...
                      >
                        <div>
                          ...
                          <CustomButton
                            ...
                            disabled={
                              this.state.aceessType === "Full Access"
                                ? false
                                : true
                            }
                          >
