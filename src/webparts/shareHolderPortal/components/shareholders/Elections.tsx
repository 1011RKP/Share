...
export class Elections extends React.Component<any, any> {
  ...
  //         data.shareholderID +
  //         " – " +
  //         data.shareholdingName.toString() +
  //         ": has updated their " +
    ...
    let check = (
      <React.Fragment>
        ...
        <div className="row" style={{ margin: "15px 0px" }}>
          <div className="col-md-4">
            <FormControl component="fieldset" fullWidth>
              <FormLabel component="legend">Federal*</FormLabel>
              <InputLabel disabled>Not applicable</InputLabel>
            </FormControl>
          </div>
        </div>
                              ...
                              {this.state.aceessType !== "Full Access" ? (
                                <React.Fragment>
                                  <h5 style={{ fontSize: "0.85rem" }}>
                                    ...
                                    />
                                    You are not authorized to make changes to
                                    this page as your access is limited to be
                                    "Read Only" by the shareholder.
                                  </h5>
                                </React.Fragment>
                              ) : null}
                            </React.Fragment>
