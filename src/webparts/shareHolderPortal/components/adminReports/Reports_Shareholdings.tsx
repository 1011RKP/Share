...
> {
  public constructor(props: any, state: any) {
    ...
    this.state = {
      data: this.props.data.shareholdings
    };
  }
          ...
          <SucessButton
            onClick={e =>
              this.exportAsExcelFile(
                e,
                this.state.data,
                "Download Shareholding Information"
              )
            }
          >
            <FontAwesomeIcon icon={faDownload} />{"  "}
            <span style={{marginLeft:"5px"}}> Download Shareholding Information</span>
          </SucessButton>
        </div>
      </div>
    );
